...
const WebDesignIcon = () => {
  return (
    <div className="card-img-top-1" data-brz-custom-id="nlrtjmkhwoarbmuozhpxmbhuzthcerrrfcbp">
      <span className="brz-icon brz-span brz-css-eWzBQ brz-css-num4D">
        <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 24 24" className="brz-icon-svg align-[initial]" data-type="glyph" data-name="web-design">
