...
import Learningpath from "./scenes/learningpath";
import Courses from "./scenes/courses/courses";
//import Active from "./scenes/courses/active";
//import Favorite from "./scenes/courses/favorite";
//import Launched from "./scenes/courses/launched";
import Projects from "./scenes/projects/projects";
import Activeprojects from "./scenes/projects/activeprojects";
import Favoriteprojects from "./scenes/projects/favoriteprojects";
import Launchedprojects from "./scenes/projects/launchedprojects";
import { CssBaseline, ThemeProvider } from "@mui/material";
import { ColorModeContext, useMode } from "./theme";
...
function App() {
    ...
    return ( <
        ...
        element = { < Projects / > }
        /> <
        Route path = "/my-active-projects"
        element = { < Activeprojects / > }
        /> <
        Route path = "/my-favorite-projects"
        element = { < Favoriteprojects / > }
        /> <
        Route path = "/my-newlylaunched-projects"
        element = { < Launchedprojects / > }
        /> < /
        Routes > <
        /main> < /
        div > <
