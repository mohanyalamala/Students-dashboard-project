...
/* Start of Campaign Section */
      /*<div className="Learningpathprogess">
      <Box flexDirection="column" marginLeft="60px" mt="25px">
        <Typography variant="h5" fontSize="30px" fontWeight="600">
          Learning path Progress
        </Typography>
        <Box display="flex" flexDirection="column"mt="25px">
          <Learningpathprogress progress={70} size={150}/>
        </Box>
  </Box>*/
...
/*import React from "react";
import Dashboardheader from "../../components/dashboardheader";
import Learningpathprogess from '../../components/Learningpathprogress';
import CoursesProgress from "../../components/Coursesprogress";
import ProjectsProgress from "../../components/ProjectsProgress";
import HOEScore from "../../components/HOEScore";
import './dashboardindex.css';
const Dashboard = () => {
//const learningPathProgress = 75; // Replace with your actual progress value
